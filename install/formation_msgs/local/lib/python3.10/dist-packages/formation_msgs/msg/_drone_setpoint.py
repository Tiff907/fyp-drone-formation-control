...
class Metaclass_DroneSetpoint(type):
    """Metaclass of message 'DroneSetpoint'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'formation_msgs.msg.DroneSetpoint')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__drone_setpoint
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__drone_setpoint
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__drone_setpoint
            cls._TYPE_SUPPORT = module.type_support_msg__msg__drone_setpoint
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__drone_setpoint
...
class DroneSetpoint(metaclass=Metaclass_DroneSetpoint):
    """Message class 'DroneSetpoint'."""
    ...
    def __init__(self, **kwargs):
        ...
        from std_msgs.msg import ColorRGBA
        self.led_color = kwargs.get('led_color', ColorRGBA())
    ...
    def led_color(self, value):
        if __debug__:
            ...
            assert \
                ...
                "The 'led_color' field must be a sub message of type 'ColorRGBA'"
