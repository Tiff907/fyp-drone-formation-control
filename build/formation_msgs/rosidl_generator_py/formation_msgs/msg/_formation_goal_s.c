...
bool formation_msgs__msg__formation_goal__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("formation_msgs.msg._formation_goal.FormationGoal", full_classname_dest, 48) == 0);
  }
  formation_msgs__msg__FormationGoal * ros_message = _ros_message;
  {  // target_points
    ...
    geometry_msgs__msg__Point * dest = ros_message->target_points.data;
  ...
  {  // assigned_drone_ids
    PyObject * field = PyObject_GetAttrString(_pymsg, "assigned_drone_ids");
    if (!field) {
      return false;
    }
    if (PyObject_CheckBuffer(field)) {
      ...
      int32_t * dest = ros_message->assigned_drone_ids.data;
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'assigned_drone_ids'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
  ...
  {  // point_colors
    PyObject * field = PyObject_GetAttrString(_pymsg, "point_colors");
    if (!field) {
      return false;
    }
    PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'point_colors'");
    if (!seq_field) {
      Py_DECREF(field);
      return false;
    }
    ...
    std_msgs__msg__ColorRGBA * dest = ros_message->point_colors.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
  ...
  {  // formation_id
    PyObject * field = PyObject_GetAttrString(_pymsg, "formation_id");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->formation_id = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // timestamp
...
{
  /* NOTE(esteve): Call constructor of FormationGoal */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("formation_msgs.msg._formation_goal");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "FormationGoal");
  ...
  {  // assigned_drone_ids
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "assigned_drone_ids");
    if (!field) {
      return NULL;
    }
    ...
    if (ros_message->assigned_drone_ids.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      int32_t * src = &(ros_message->assigned_drone_ids.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->assigned_drone_ids.size * sizeof(int32_t));
      assert(data != NULL);
  ...
  {  // point_colors
    ...
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->point_colors.data[i]);
    ...
    assert(PySequence_Check(field));
    {
      int rc = PyObject_SetAttrString(_pymessage, "point_colors", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // formation_id
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->formation_id);
    {
      int rc = PyObject_SetAttrString(_pymessage, "formation_id", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
