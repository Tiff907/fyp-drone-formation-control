...
bool formation_msgs__msg__drone_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("formation_msgs.msg._drone_state.DroneState", full_classname_dest, 42) == 0);
  }
  formation_msgs__msg__DroneState * ros_message = _ros_message;
  {  // drone_id
  ...
  {  // reached_target
    PyObject * field = PyObject_GetAttrString(_pymsg, "reached_target");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->reached_target = (Py_True == field);
    Py_DECREF(field);
  }
...
PyObject * formation_msgs__msg__drone_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("formation_msgs.msg._drone_state");
  ...
  {  // reached_target
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->reached_target ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "reached_target", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
