...
#include "formation_msgs/msg/detail/user_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const formation_msgs::msg::UserCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  formation_msgs::msg::UserCommand & ros_message)
{
  // Member: command
  cdr >> ros_message.command;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = formation_msgs::msg::UserCommand;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const formation_msgs::msg::UserCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<formation_msgs::msg::UserCommand *>(
    untyped_ros_message);
...
{
  return &formation_msgs::msg::typesupport_fastrtps_cpp::_UserCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, formation_msgs, msg, UserCommand)() {
  return &formation_msgs::msg::typesupport_fastrtps_cpp::_UserCommand__handle;
}
