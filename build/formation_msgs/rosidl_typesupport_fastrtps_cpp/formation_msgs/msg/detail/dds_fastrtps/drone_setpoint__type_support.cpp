...
#include "formation_msgs/msg/detail/drone_setpoint__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = formation_msgs::msg::DroneSetpoint;
    is_plain =
      (
      offsetof(DataType, led_color) +
      last_member_size
      ) == ret_val;
  }
...
static bool _DroneSetpoint__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  auto typed_message =
    static_cast<const formation_msgs::msg::DroneSetpoint *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}

static bool _DroneSetpoint__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  auto typed_message =
    static_cast<formation_msgs::msg::DroneSetpoint *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _DroneSetpoint__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const formation_msgs::msg::DroneSetpoint *>(
...
static size_t _DroneSetpoint__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_DroneSetpoint(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _DroneSetpoint__callbacks = {
  "formation_msgs::msg",
  "DroneSetpoint",
  _DroneSetpoint__cdr_serialize,
  _DroneSetpoint__cdr_deserialize,
  _DroneSetpoint__get_serialized_size,
  _DroneSetpoint__max_serialized_size
};

static rosidl_message_type_support_t _DroneSetpoint__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_DroneSetpoint__callbacks,
...
{
  return &formation_msgs::msg::typesupport_fastrtps_cpp::_DroneSetpoint__handle;
}
