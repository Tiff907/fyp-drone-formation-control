...
#include "formation_msgs/msg/detail/drone_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const formation_msgs::msg::DroneState & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  cdr << (ros_message.reached_target ? true : false);
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  formation_msgs::msg::DroneState & ros_message)
{
  // Member: drone_id
  cdr >> ros_message.drone_id;
  ...
  // Member: reached_target
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message.reached_target = tmp ? true : false;
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: reached_target
  {
    size_t item_size = sizeof(ros_message.reached_target);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = formation_msgs::msg::DroneState;
    is_plain =
      (
      offsetof(DataType, reached_target) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const formation_msgs::msg::DroneState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<formation_msgs::msg::DroneState *>(
    untyped_ros_message);
...
{
  return &formation_msgs::msg::typesupport_fastrtps_cpp::_DroneState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, formation_msgs, msg, DroneState)() {
  return &formation_msgs::msg::typesupport_fastrtps_cpp::_DroneState__handle;
}
