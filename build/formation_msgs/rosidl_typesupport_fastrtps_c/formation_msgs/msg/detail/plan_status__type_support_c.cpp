...
#include "formation_msgs/msg/detail/plan_status__rosidl_typesupport_fastrtps_c.h"
...
using _PlanStatus__ros_msg_type = formation_msgs__msg__PlanStatus;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _PlanStatus__ros_msg_type * ros_message = static_cast<const _PlanStatus__ros_msg_type *>(untyped_ros_message);
  // Field name: success
  {
  ...
  void * untyped_ros_message)
{
  ...
  _PlanStatus__ros_msg_type * ros_message = static_cast<_PlanStatus__ros_msg_type *>(untyped_ros_message);
  // Field name: success
  {
    uint8_t tmp;
    cdr >> tmp;
...
size_t get_serialized_size_formation_msgs__msg__PlanStatus(
  const void * untyped_ros_message,
...
static uint32_t _PlanStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_formation_msgs__msg__PlanStatus(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_formation_msgs
size_t max_serialized_size_formation_msgs__msg__PlanStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = formation_msgs__msg__PlanStatus;
    is_plain =
      (
...
static size_t _PlanStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_formation_msgs__msg__PlanStatus(
...
static message_type_support_callbacks_t __callbacks_PlanStatus = {
  "formation_msgs::msg",
  "PlanStatus",
...
static rosidl_message_type_support_t _PlanStatus__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_PlanStatus,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, formation_msgs, msg, PlanStatus)() {
  return &_PlanStatus__type_support;
}
