...
#include "formation_msgs/msg/detail/system_state__rosidl_typesupport_fastrtps_c.h"
...
using _SystemState__ros_msg_type = formation_msgs__msg__SystemState;
...
size_t get_serialized_size_formation_msgs__msg__SystemState(
  const void * untyped_ros_message,
...
static uint32_t _SystemState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_formation_msgs__msg__SystemState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_formation_msgs
size_t max_serialized_size_formation_msgs__msg__SystemState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = formation_msgs__msg__SystemState;
    is_plain =
      (
...
static size_t _SystemState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_formation_msgs__msg__SystemState(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, formation_msgs, msg, SystemState)() {
