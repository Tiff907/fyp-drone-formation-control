...
bool formation_msgs__msg__user_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("formation_msgs.msg._user_command.UserCommand", full_classname_dest, 44) == 0);
  }
  formation_msgs__msg__UserCommand * ros_message = _ros_message;
  {  // command
...
PyObject * formation_msgs__msg__user_command__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("formation_msgs.msg._user_command");
